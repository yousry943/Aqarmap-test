        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" action="{{url(LaravelLocalization::setLocale().'/admin/articles/'.$articles->first()->id)}}">
                        {{csrf_field()}}
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="text" name="title" class="form-control" id="name" placeholder="title" value="{{$articles->first()->title}}">
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input type="textarea" name="description" class="form-control" id="name" placeholder="description" value="{{$articles->first()->description}}">
                              </div>
